      ...
      <div class="row">
        ...
        <section class="col-md-12">
          ...
          <div class="card">
            ...
            <div class="card-body">
              <form action="{{route('news_events.store')}}" id="myform" method="post" enctype="multipart/form-data">
                @csrf
                <div class="form-row">

                  <div class="form-group col-md-4">
                    <label for="date">Date</label>
                    <input type="text" name="date" id="datepicker" placeholder="YYYY-MM-DD" readonly>
                  </div>
