...
<html lang="en">
    <head>
        ...
        <!-- chart -->
        <link rel="stylesheet" type="text/css" href="{{asset('https://cdnjs.cloudflare.com/ajax/libs/toastr.js/2.1.4/toastr.css')}}">
                ...
                <ul class="header_menu">
                        ...
                        <div class="dropdown_wrapper messages_item dropdown-menu dropdown-menu-right">
                            ...
                            <ul class="dropdown_body nice_scroll scrollbar">
                                ...
                                <li>
                                    <a href="#">
                                        <div class="img-part">
                                            <img src="{{asset('public/panel/assets/images/user.jpg')}}" alt="" class="img-fluid">
                                        </div>
                                        <div class="text-part">
                                            <h6>Madelyn <span><i class="far fa-clock"></i> today</span></h6>
                                            <p>Hello Sam...</p>
                    ...
                    <li><a data-toggle="dropdown" href="#"><i class="far fa-user"></i></a>
                            <div class="user_item dropdown-menu dropdown-menu-right">
                                <div class="admin">
                                    <a href="#" class="user_link"><img src="{{asset('public/panel/assets/images/user1.jpg')}}" alt=""></a>
                                </div>
                            <ul>
              ...
              <nav class="sidebar-nav">
                 <ul class="metismenu" id="menu1">
                    ...
                    <li class="single-nav-wrapper">
                      ...
                      <li class="single-nav-wrapper">
                        <a href="{{asset('blank_page')}}" class="menu-item">
...
@yield('content')
   ...
   <script src="{{asset('public/panel/assets/plugins/chartjs-bar-chart/Chart.min.js')}}"></script>
        ...
        <script src="{{asset('public/panel/assets/plugins/pie_chart/pie.active.js')}}"></script>
         <script type="text/javascript" src="{{asset('https://cdnjs.cloudflare.com/ajax/libs/toastr.js/2.1.4/toastr.min.js')}}" ></script>
